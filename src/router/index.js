...
export const asyncRouterMap = [
  ...
  // },
  {
    ...
    redirect: 'noredirect',
    name: 'dishesSet',
    meta: { title: 'dishesSet', icon: 'dishesSet' },
    children: [
      { path: 'dishesClass', component: _import('dishesSet/dishesClass'), name: 'dishesClass', meta: { title: 'dishesClass', icon: 'dishesClass', noCache: true }},
      { path: 'dishesGroup', component: _import('dishesSet/dishesGroup'), name: 'dishesGroup', meta: { title: 'dishesGroup', icon: 'dishesGroup', noCache: true }},
      { path: 'dishes', component: _import('dishesSet/dishes'), name: 'dishes', meta: { title: 'dishes', icon: 'dishes', noCache: true }}
    ]
  },
  // {
  //   path: '/icon',
